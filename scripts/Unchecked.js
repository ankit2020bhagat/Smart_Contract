...
const Mycontract=require('../build/contracts/Unchecked.json');
const init=async()=>{
  ...
  contract.methods.f(2,1).send({from:addresses[0]}).then(console.log);
  contract.methods.g(2,1).send({from:addresses[0]}).then(console.log);
