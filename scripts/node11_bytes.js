...
const Mycontract=require('../build/contracts/Bytes.json');
const init=async()=>{
   ...
   let contract=new web3.eth.Contract(Mycontract.abi,"0x634548eeC3B7877279DcA08ebC96874036CFfe63");
   ...
   contract.methods.setter().send({from:addresses[0]});
  // contract.methods.balances(addresses[1]).call().then(console.log)
  contract.methods.b3().call().then(console.log);
  contract.methods.b2().call().then(console.log);
}
