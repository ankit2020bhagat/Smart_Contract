...
const Mycontract=require('../build/contracts/function3.json');
const init=async()=>{
   ...
   let contract=new web3.eth.Contract(Mycontract.abi,"0x21567301D48e54032215a0DE7374D895ECB72764");
   ...
   contract.methods.callhelloworld().call().then(console.log);
